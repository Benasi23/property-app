-- =====================================================================
-- Adds a "finance_approved" pipeline stage, sitting between
-- Under Contract and Sold. Run once in the Supabase SQL Editor. Idempotent.
-- =====================================================================

alter table public.properties drop constraint if exists properties_status_check;
alter table public.properties add constraint properties_status_check
  check (status in ('available','hold','reserved','under_contract','finance_approved','sold','withdrawn'));
...
declare
  ...
  v_avail boolean;
begin
  if p_status not in ('available','hold','reserved','under_contract','finance_approved','sold','withdrawn') then
  ...
  elsif p_status in ('hold','reserved','under_contract','finance_approved') then
